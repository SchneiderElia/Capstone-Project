(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@tiptap/react'), require('lowlight/lib/core'), require('@tiptap/core'), require('prosemirror-view'), require('prosemirror-state'), require('@tiptap/extension-text-style'), require('@tiptap/starter-kit'), require('@tiptap/extension-code-block-lowlight'), require('@tiptap/extension-focus'), require('@tiptap/extension-link'), require('@tiptap/extension-dropcursor'), require('@emotion/styled'), require('polished'), require('react-colorful'), require('axios'), require('medium-zoom'), require('prop-types'), require('use-countdown-timer'), require('@emotion/react')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', '@tiptap/react', 'lowlight/lib/core', '@tiptap/core', 'prosemirror-view', 'prosemirror-state', '@tiptap/extension-text-style', '@tiptap/starter-kit', '@tiptap/extension-code-block-lowlight', '@tiptap/extension-focus', '@tiptap/extension-link', '@tiptap/extension-dropcursor', '@emotion/styled', 'polished', 'react-colorful', 'axios', 'medium-zoom', 'prop-types', 'use-countdown-timer', '@emotion/react'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.Dante = {}, global.React, global.react, global.core$1, global.core, global.prosemirrorView, global.prosemirrorState, global.TextStyle, global.StarterKit, global.CodeBlockLowlight, global.Focus, global.Link, global.Dropcursor, global.styled, global.polished, global.reactColorful, global.axios, global.mediumZoom, global.PropTypes, global.useCountdownTimer, global.react$1));
})(this, (function (exports, React, react, core$1, core, prosemirrorView, prosemirrorState, TextStyle, StarterKit, CodeBlockLowlight, Focus, Link, Dropcursor, styled, polished, reactColorful, axios, mediumZoom, PropTypes, useCountdownTimer, react$1) { 'use strict';
  ...
  ***************************************************************************** */
  ...
  }, function (props) { return polished.lighten(0.3, props.theme.dante_text_color); }, function (props) {
  ...
  }, function (props) { return props.theme.dante_font_family_sans; }, function (props) { return polished.lighten(0.2, props.theme.dante_text_color); });
  ...
  }, function (props) { return props.theme.tooltip_color; }, function (props) { return props.theme.tooltip_button_spacing; }, function (props) { return props.theme.tooltip_border_radius; }, function (props) { return props.theme.dante_font_family_sans; }, function (props) { return props.theme.tooltip_size; }, function (props) { return props.theme.tooltip_size; }, function (props) { return props.theme.tooltip_line_height; }, function (props) { return props.theme.tooltip_background_color; }, function (props) { return props.theme.tooltip_border_width; }, function (props) { return polished.opacify(0.2, props.theme.tooltip_border_color); }, function (props) { return props.theme.tooltip_color; }, function (props) { return polished.opacify(0.4, props.theme.tooltip_border_color); }, function (props) { return props.theme.tooltip_color; }, function (props) {
  ...
  var templateObject_1$d, templateObject_2$4, templateObject_3$4;
  ...
  function MaybeFloating(_a) {
      ...
      if (!fixed)
          return React.createElement(react.FloatingMenu, { editor: editor, tippyOptions: { duration: 100, arrow: false, interactive: true } }, isPopOverEnabledFor() && (children));
      return children;
  }
  // @ts-ignore
  ...
  */
  ...
  var AnchorStyle = styled.div(templateObject_1$c || (templateObject_1$c = __makeTemplateObject(["\n  // MENU\n  //position: absolute;\n  //visibility: hidden;\n  z-index: 10;\n  -webkit-transition: none;\n  transition: none;\n  display: none;\n  top: 0;\n  left: 0;\n  display: block;\n  white-space: nowrap;\n\n  height: ", ";\n  background: ", ";\n  color: ", ";\n\n  border: ", ";\n  border-radius: ", ";\n  box-shadow: ", ";\n\n  // CARET\n  // &:before -> Borde\n  // &:after  -> Triangulo\n\n  &.dante-menu {\n    &:after {\n      content: \"\";\n      height: 0;\n      width: 0;\n      position: absolute;\n      left: ", ";\n      pointer-events: none;\n      border: ", " solid transparent;\n      margin-left: -", ";\n    }\n    &:after {\n      border-top-color: ", ";\n      bottom: -", ";\n    }\n  }\n\n  &.dante-sticky-menu {\n    position: -webkit-sticky;\n    position: sticky;\n    width: 100%;\n    border-radius: 0px;\n    //overflow-x: scroll;\n    &:after {\n      display: none;\n    }\n  }\n\n  &.is-active {\n    visibility: visible;\n    opacity: 1;\n    transition: visibility 0s linear 0s, opacity 0.2s 0s;\n  }\n\n  &.is-active {\n    opacity: 1;\n  }\n\n  // Visible\n\n  &.dante-menu--active {\n    display: inline-block !important;\n    visibility: visible !important;\n    -webkit-animation: pop-upwards 180ms forwards linear;\n    animation: pop-upwards 180ms forwards linear;\n  }\n\n  // Link mode\n\n  &.dante-menu--linkmode {\n    .dante-menu-buttons {\n      visibility: hidden;\n    }\n    .dante-menu-linkinput {\n      display: block;\n    }\n    .dante-menu-input {\n      -webkit-animation: pop-upwards 180ms forwards linear;\n      animation: pop-upwards 180ms forwards linear;\n    }\n  }\n\n  &.popover--Linktooltip .popover-inner {\n    padding: 10px 10px;\n    font-size: 12px;\n  }\n\n  &.popover--tooltip .popover-inner {\n    //background: #333333;\n    border-radius: 4px;\n    color: ", ";\n  }\n\n  .popover-inner a {\n    color: inherit;\n    text-decoration: none;\n  }\n\n  .popover-arrow {\n    position: absolute;\n  }\n\n  .popover-arrow:after {\n    background-color: ", ";\n  }\n\n  &.popover--top .popover-arrow,\n  &.popover--bottom .popover-arrow {\n    left: 50%;\n    margin-left: -", ";\n  }\n\n  &.popover--left .popover-arrow,\n  &.popover--right .popover-arrow {\n    top: 50%;\n    margin-top: -", ";\n  }\n\n  &.popover--right .popover-arrow {\n    left: 1px;\n  }\n\n  &.popover--bottom .popover-arrow {\n    top: -13px;\n  }\n\n  &.popover--left .popover-arrow {\n    right: 1px;\n    // clip: rect(-4px 14px 18px 0);\n  }\n\n  .popover-arrow:after {\n    content: \"\";\n    display: block;\n    width: ", ";\n    height: ", ";\n  }\n\n  &.popover--top .popover-arrow:after {\n    -webkit-transform: rotate(45deg) translate(-5px, -5px);\n    -ms-transform: rotate(45deg) translate(-5px, -5px);\n    transform: rotate(45deg) translate(-5px, -5px);\n    box-shadow: 1px 1px 1px -1px ", ";\n  }\n\n  &.popover--right .popover-arrow:after {\n    -webkit-transform: rotate(45deg) translate(6px, -6px);\n    -ms-transform: rotate(45deg) translate(6px, -6px);\n    transform: rotate(45deg) translate(6px, -6px);\n    box-shadow: -1px 1px 1px -1px ", ";\n  }\n\n  &.popover--bottom .popover-arrow:after {\n    -webkit-transform: rotate(45deg) translate(6px, 6px);\n    -ms-transform: rotate(45deg) translate(6px, 6px);\n    transform: rotate(45deg) translate(6px, 6px);\n    box-shadow: -1px -1px 1px -1px ", ";\n  }\n\n  &.popover--left .popover-arrow:after {\n    -webkit-transform: rotate(45deg) translate(-6px, 6px);\n    -ms-transform: rotate(45deg) translate(-6px, 6px);\n    transform: rotate(45deg) translate(-6px, 6px);\n    box-shadow: 1px -1px 1px -1px ", ";\n  }\n\n  // BUTONS\n\n  .dante-menu-buttons {\n    list-style: none;\n    margin: 0;\n    padding: 0;\n    line-height: 0;\n  }\n  .dante-menu-divider {\n    width: 1px;\n    height: ", ";\n    margin: 9px 2px;\n    background: rgba(100, 100, 100, 0.2);\n    display: inline-block;\n    overflow: hidden;\n    cursor: default;\n    line-height: ", ";\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n  }\n  .dante-menu-button,\n  button {\n    background-color: transparent;\n    min-width: 20px;\n    display: inline-block;\n    padding-left: 10px;\n    padding-right: 10px;\n    overflow: hidden;\n    text-align: center;\n    color: ", ";\n    cursor: pointer;\n    font-size: ", ";\n    line-height: ", ";\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n\n    &:hover {\n      // nada\n    }\n    &.active {\n      color: ", ";\n    }\n\n    &:first-of-type {\n      border-top-left-radius: ", ";\n      border-bottom-left-radius: ", ";\n      padding-left: 18px;\n    }\n    &:last-child {\n      border-top-right-radius: ", ";\n      border-bottom-right-radius: ", ";\n      padding-right: 18px;\n    }\n  }\n\n  .dante-menu-button--disabled {\n    -webkit-user-select: none !important;\n    -moz-user-select: none !important;\n    -ms-user-select: none !important;\n    user-select: none !important;\n    opacity: 0.3;\n  }\n\n  // LINK\n\n  .dante-menu-linkinput {\n    & {\n      display: none;\n      position: absolute;\n      top: 0;\n      left: 0;\n      right: 0;\n      bottom: 0;\n    }\n    .dante-menu-button {\n      position: absolute;\n      top: 0;\n      right: 0;\n    }\n  }\n\n  .dante-menu-input {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    padding: 13px 40px 13px 10px;\n    color: ", ";\n    background: transparent;\n    border: none;\n    outline: none;\n    font-size: 14px;\n    box-sizing: border-box;\n    border-radius: ", ";\n    appearance: none;\n    text-align: left;\n    font-family: ", ";\n    letter-spacing: 0.01rem;\n    font-weight: 400;\n    font-style: normal;\n    text-rendering: optimizeLegibility;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n    -moz-font-feature-settings: \"liga\" on;\n  }\n\n  &:after {\n    border-top-color: ", ";\n  }\n  .dante-menu-input {\n    padding: 11px 40px 11px 10px;\n  }\n  .dante-menu-button {\n    padding-left: 0;\n    padding-right: 0;\n    vertical-align: top;\n    line-height: 1;\n    margin: 0px;\n  }\n  .dante-menu-button:first-of-type {\n    border-top-left-radius: 4px;\n    border-bottom-left-radius: 4px;\n    padding-left: 0;\n  }\n  .dante-menu-button:last-of-type {\n    border-top-right-radius: 4px;\n    border-bottom-right-radius: 4px;\n    padding-right: 0;\n  }\n  .dante-menu-button.visible-overflow {\n    vertical-align: top;\n  }\n  .dante-menu-button button {\n    height: 42px;\n  }\n  .dante-menu-button .dante-icon {\n    padding: 10px;\n    min-width: 20px;\n    display: inline-block;\n  }\n  .dante-menu-button .tooltip-icon {\n    padding: 10px;\n    display: inline-block;\n  }\n\n  .dante-menu-button .dante-icon:hover .icon-fillcolor {\n    fill: ", ";\n  }\n  .dante-menu-button.active .dante-icon .icon-fillcolor {\n    fill: ", ";\n  }\n\n  .dante-menu-button .dante-icon svg {\n    display: inherit !important;\n    vertical-align: inherit !important;\n  }\n  .dropdown {\n    float: left;\n  }\n  .dropdown .btn {\n    color: #bec2cc;\n    padding: 0 10px;\n    width: auto;\n    font-size: 12px;\n  }\n  .dropdown .btn .caret {\n    border-top-color: #62656a;\n    margin-left: 4px;\n  }\n  .dropdown .btn:hover {\n    color: ", ";\n  }\n  .dropdown .btn:hover .caret {\n    border-top-color: ", ";\n  }\n  .dropdown .dropdown-menu {\n    background: #2a2b32;\n    padding: 0;\n    max-height: 300px;\n    overflow-y: auto;\n    width: auto;\n    min-width: 60px;\n  }\n  .dropdown .dropdown-menu li {\n    border-bottom: 1px solid #383943;\n  }\n  .dropdown .dropdown-menu li:last-child {\n    border-bottom: 0;\n  }\n  .dropdown .dropdown-menu li a {\n    color: #bec2cc;\n    font-size: 12px;\n    padding: 0 10px;\n    line-height: 30px;\n  }\n  .dropdown.open > .dropdown-toggle.btn-default {\n    color: #bec2cc;\n  }\n  .dropdown .dropdown-menu li a:hover,\n  .dropdown.open > .dropdown-toggle.btn-default:hover {\n    background: 0;\n    color: ", ";\n  }\n\n  .divider {\n    position: relative;\n    float: left;\n    width: 1px;\n    height: 20px;\n    margin: 10px 5px;\n    background: ", ";\n  }\n"], ["\n  // MENU\n  //position: absolute;\n  //visibility: hidden;\n  z-index: 10;\n  -webkit-transition: none;\n  transition: none;\n  display: none;\n  top: 0;\n  left: 0;\n  display: block;\n  white-space: nowrap;\n\n  height: ", ";\n  background: ", ";\n  color: ", ";\n\n  border: ", ";\n  border-radius: ", ";\n  box-shadow: ", ";\n\n  // CARET\n  // &:before -> Borde\n  // &:after  -> Triangulo\n\n  &.dante-menu {\n    &:after {\n      content: \"\";\n      height: 0;\n      width: 0;\n      position: absolute;\n      left: ", ";\n      pointer-events: none;\n      border: ", " solid transparent;\n      margin-left: -", ";\n    }\n    &:after {\n      border-top-color: ", ";\n      bottom: -", ";\n    }\n  }\n\n  &.dante-sticky-menu {\n    position: -webkit-sticky;\n    position: sticky;\n    width: 100%;\n    border-radius: 0px;\n    //overflow-x: scroll;\n    &:after {\n      display: none;\n    }\n  }\n\n  &.is-active {\n    visibility: visible;\n    opacity: 1;\n    transition: visibility 0s linear 0s, opacity 0.2s 0s;\n  }\n\n  &.is-active {\n    opacity: 1;\n  }\n\n  // Visible\n\n  &.dante-menu--active {\n    display: inline-block !important;\n    visibility: visible !important;\n    -webkit-animation: pop-upwards 180ms forwards linear;\n    animation: pop-upwards 180ms forwards linear;\n  }\n\n  // Link mode\n\n  &.dante-menu--linkmode {\n    .dante-menu-buttons {\n      visibility: hidden;\n    }\n    .dante-menu-linkinput {\n      display: block;\n    }\n    .dante-menu-input {\n      -webkit-animation: pop-upwards 180ms forwards linear;\n      animation: pop-upwards 180ms forwards linear;\n    }\n  }\n\n  &.popover--Linktooltip .popover-inner {\n    padding: 10px 10px;\n    font-size: 12px;\n  }\n\n  &.popover--tooltip .popover-inner {\n    //background: #333333;\n    border-radius: 4px;\n    color: ", ";\n  }\n\n  .popover-inner a {\n    color: inherit;\n    text-decoration: none;\n  }\n\n  .popover-arrow {\n    position: absolute;\n  }\n\n  .popover-arrow:after {\n    background-color: ", ";\n  }\n\n  &.popover--top .popover-arrow,\n  &.popover--bottom .popover-arrow {\n    left: 50%;\n    margin-left: -", ";\n  }\n\n  &.popover--left .popover-arrow,\n  &.popover--right .popover-arrow {\n    top: 50%;\n    margin-top: -", ";\n  }\n\n  &.popover--right .popover-arrow {\n    left: 1px;\n  }\n\n  &.popover--bottom .popover-arrow {\n    top: -13px;\n  }\n\n  &.popover--left .popover-arrow {\n    right: 1px;\n    // clip: rect(-4px 14px 18px 0);\n  }\n\n  .popover-arrow:after {\n    content: \"\";\n    display: block;\n    width: ", ";\n    height: ", ";\n  }\n\n  &.popover--top .popover-arrow:after {\n    -webkit-transform: rotate(45deg) translate(-5px, -5px);\n    -ms-transform: rotate(45deg) translate(-5px, -5px);\n    transform: rotate(45deg) translate(-5px, -5px);\n    box-shadow: 1px 1px 1px -1px ", ";\n  }\n\n  &.popover--right .popover-arrow:after {\n    -webkit-transform: rotate(45deg) translate(6px, -6px);\n    -ms-transform: rotate(45deg) translate(6px, -6px);\n    transform: rotate(45deg) translate(6px, -6px);\n    box-shadow: -1px 1px 1px -1px ", ";\n  }\n\n  &.popover--bottom .popover-arrow:after {\n    -webkit-transform: rotate(45deg) translate(6px, 6px);\n    -ms-transform: rotate(45deg) translate(6px, 6px);\n    transform: rotate(45deg) translate(6px, 6px);\n    box-shadow: -1px -1px 1px -1px ", ";\n  }\n\n  &.popover--left .popover-arrow:after {\n    -webkit-transform: rotate(45deg) translate(-6px, 6px);\n    -ms-transform: rotate(45deg) translate(-6px, 6px);\n    transform: rotate(45deg) translate(-6px, 6px);\n    box-shadow: 1px -1px 1px -1px ", ";\n  }\n\n  // BUTONS\n\n  .dante-menu-buttons {\n    list-style: none;\n    margin: 0;\n    padding: 0;\n    line-height: 0;\n  }\n  .dante-menu-divider {\n    width: 1px;\n    height: ", ";\n    margin: 9px 2px;\n    background: rgba(100, 100, 100, 0.2);\n    display: inline-block;\n    overflow: hidden;\n    cursor: default;\n    line-height: ", ";\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n  }\n  .dante-menu-button,\n  button {\n    background-color: transparent;\n    min-width: 20px;\n    display: inline-block;\n    padding-left: 10px;\n    padding-right: 10px;\n    overflow: hidden;\n    text-align: center;\n    color: ", ";\n    cursor: pointer;\n    font-size: ", ";\n    line-height: ", ";\n    -webkit-user-select: none;\n    -moz-user-select: none;\n    -ms-user-select: none;\n    user-select: none;\n\n    &:hover {\n      // nada\n    }\n    &.active {\n      color: ", ";\n    }\n\n    &:first-of-type {\n      border-top-left-radius: ", ";\n      border-bottom-left-radius: ", ";\n      padding-left: 18px;\n    }\n    &:last-child {\n      border-top-right-radius: ", ";\n      border-bottom-right-radius: ", ";\n      padding-right: 18px;\n    }\n  }\n\n  .dante-menu-button--disabled {\n    -webkit-user-select: none !important;\n    -moz-user-select: none !important;\n    -ms-user-select: none !important;\n    user-select: none !important;\n    opacity: 0.3;\n  }\n\n  // LINK\n\n  .dante-menu-linkinput {\n    & {\n      display: none;\n      position: absolute;\n      top: 0;\n      left: 0;\n      right: 0;\n      bottom: 0;\n    }\n    .dante-menu-button {\n      position: absolute;\n      top: 0;\n      right: 0;\n    }\n  }\n\n  .dante-menu-input {\n    position: absolute;\n    top: 0;\n    left: 0;\n    width: 100%;\n    padding: 13px 40px 13px 10px;\n    color: ", ";\n    background: transparent;\n    border: none;\n    outline: none;\n    font-size: 14px;\n    box-sizing: border-box;\n    border-radius: ", ";\n    appearance: none;\n    text-align: left;\n    font-family: ", ";\n    letter-spacing: 0.01rem;\n    font-weight: 400;\n    font-style: normal;\n    text-rendering: optimizeLegibility;\n    -webkit-font-smoothing: antialiased;\n    -moz-osx-font-smoothing: grayscale;\n    -moz-font-feature-settings: \"liga\" on;\n  }\n\n  &:after {\n    border-top-color: ", ";\n  }\n  .dante-menu-input {\n    padding: 11px 40px 11px 10px;\n  }\n  .dante-menu-button {\n    padding-left: 0;\n    padding-right: 0;\n    vertical-align: top;\n    line-height: 1;\n    margin: 0px;\n  }\n  .dante-menu-button:first-of-type {\n    border-top-left-radius: 4px;\n    border-bottom-left-radius: 4px;\n    padding-left: 0;\n  }\n  .dante-menu-button:last-of-type {\n    border-top-right-radius: 4px;\n    border-bottom-right-radius: 4px;\n    padding-right: 0;\n  }\n  .dante-menu-button.visible-overflow {\n    vertical-align: top;\n  }\n  .dante-menu-button button {\n    height: 42px;\n  }\n  .dante-menu-button .dante-icon {\n    padding: 10px;\n    min-width: 20px;\n    display: inline-block;\n  }\n  .dante-menu-button .tooltip-icon {\n    padding: 10px;\n    display: inline-block;\n  }\n\n  .dante-menu-button .dante-icon:hover .icon-fillcolor {\n    fill: ", ";\n  }\n  .dante-menu-button.active .dante-icon .icon-fillcolor {\n    fill: ", ";\n  }\n\n  .dante-menu-button .dante-icon svg {\n    display: inherit !important;\n    vertical-align: inherit !important;\n  }\n  .dropdown {\n    float: left;\n  }\n  .dropdown .btn {\n    color: #bec2cc;\n    padding: 0 10px;\n    width: auto;\n    font-size: 12px;\n  }\n  .dropdown .btn .caret {\n    border-top-color: #62656a;\n    margin-left: 4px;\n  }\n  .dropdown .btn:hover {\n    color: ", ";\n  }\n  .dropdown .btn:hover .caret {\n    border-top-color: ", ";\n  }\n  .dropdown .dropdown-menu {\n    background: #2a2b32;\n    padding: 0;\n    max-height: 300px;\n    overflow-y: auto;\n    width: auto;\n    min-width: 60px;\n  }\n  .dropdown .dropdown-menu li {\n    border-bottom: 1px solid #383943;\n  }\n  .dropdown .dropdown-menu li:last-child {\n    border-bottom: 0;\n  }\n  .dropdown .dropdown-menu li a {\n    color: #bec2cc;\n    font-size: 12px;\n    padding: 0 10px;\n    line-height: 30px;\n  }\n  .dropdown.open > .dropdown-toggle.btn-default {\n    color: #bec2cc;\n  }\n  .dropdown .dropdown-menu li a:hover,\n  .dropdown.open > .dropdown-toggle.btn-default:hover {\n    background: 0;\n    color: ", ";\n  }\n\n  .divider {\n    position: relative;\n    float: left;\n    width: 1px;\n    height: 20px;\n    margin: 10px 5px;\n    background: ", ";\n  }\n"])), function (props) {
      ...
      var theme = _a.theme, fixed = _a.fixed;
      return fixed ? 0 : theme.dante_menu_caret_size;
  }, function (props) { return polished.math("".concat(props.theme.dante_menu_caret_size, " / 2")); }, function (props) { return props.theme.dante_menu_background; }, function (props) { return polished.math("".concat(props.theme.dante_menu_caret_size, " * 2 - 1")); }, function (props) { return props.theme.dante_menu_color; }, function (props) { return props.theme.dante_menu_background; }, function (props) { return polished.math("".concat(props.theme.tooltip_caret_size, " / 2")); }, function (props) { return polished.math("".concat(props.theme.tooltip_caret_size, "/2")); }, function (props) { return props.theme.tooltip_caret_size; }, function (props) { return props.theme.tooltip_caret_size; }, function (props) { return props.theme.menu_tone; }, function (props) { return props.theme.menu_tone; }, function (props) { return props.theme.menu_tone; }, function (props) { return props.theme.menu_tone; }, function (props) { return polished.math("".concat(props.theme.dante_menu_height, " - 18")); }, function (props) { return props.theme.dante_menu_height; }, function (props) { return props.theme.dante_menu_icon_color; }, function (props) { return props.theme.dante_menu_icon_size; }, function (props) { return props.theme.dante_menu_height; }, function (props) { return props.theme.dante_menu_icon_accent; }, function (props) {
      ...
      function renderColor() {
          ...
          if (open) {
              return (React.createElement("div", { style: {
                  ...
                  React.createElement(reactColorful.HexColorPicker, { color: v, 
                      // @ts-ignore
  ...
  function MenuBar(_a) {
      ...
      var fixed = configTooltip.fixed;
      var _c = React.useState(false), show = _c[0]; _c[1];
      if (!editor) {
          return null;
      }
      ...
      return (React.createElement(React.Fragment, null,
          fixed && renderMenu(),
          !fixed && (React.createElement(react.BubbleMenu, { editor: editor },
              renderMenu(),
              renderImageTooptip()))));
  }
  ...
  var dante_inversed_color$1 = "#000";
  var dante_accent_color$1 = "#5BD974";
  var dante_text_color$1 = "#fefefe";
  var theme$1 = {
    ...
    dante_font_family_sans_serif: dante_font_family_sans_serif$1,
    ...
    dante_menu_box_shadow: "1px 1px 3px 0px ".concat(dante_control_color$1),
    dante_menu_icon_size: "16px",
    dante_menu_icon_color: "#000",
    dante_menu_icon_accent: dante_accent_color$1,
    dante_menu_divider_color: dante_control_color$1,
  ...
  var StyleWrapper$7 = styled(react.NodeViewWrapper)(templateObject_1$b || (templateObject_1$b = __makeTemplateObject([""], [""])));
  function ImageBlock(props) {
      ...
      return (React.createElement(StyleWrapper$7, { selected: props.selected, as: "figure", "data-drag-handle": "true", className: "graf graf--figure ".concat(directionClass(), " ").concat(props.selected ? "is-selected is-mediaFocused" : "") },
          ...
          React.createElement(react.NodeViewContent, { as: "figcaption", className: "imageCaption" }, props.node.content.size === 0 && (React.createElement("span", { className: "danteDefaultPlaceholder" }, "type a caption (optional)")))));
  }
  var ImageBlockConfig = function (options) {
      ...
      var config = {
          ...
          dataSerializer: function (data) {
              return _assign(_assign({}, data), { src: data.url || data.src, url: data.src, aspect_ratio: JSON.stringify(data.aspect_ratio), file: null });
          },
          options: {
  ...
  function ImageRenderer(_a) {
      ...
      var url = data.url, src = data.src, aspect_ratio = data.aspect_ratio, caption = data.caption;
      ...
      var defaultStyle = { maxWidth: "".concat(width, "px"), maxHeight: "".concat(height, "px") };
      ...
      var defaultAlignment = directionClass(data.direction);
      function resolveCaption() {
          if (!caption)
              return getSrc();
          if (caption === "type a caption (optional)")
              return url;
          return caption;
      }
      function getSrc() {
      ...
      return (React.createElement("figure", { key: blockKey, className: "graf graf--figure ".concat(defaultAlignment) },
          React.createElement("div", null,
              React.createElement("div", { className: "aspectRatioPlaceholder is-locked", style: defaultStyle },
                  React.createElement("div", { className: "aspect-ratio-fill", style: { paddingBottom: "".concat(ratio, "%") } }),
                  React.createElement(ReactMediumZoom, { src: getUrl(getSrc(), domain), width: width, height: height, className: "graf-image medium-zoom-image", alt: resolveCaption() }))),
  ...
  var StyleWrapper$6 = styled(react.NodeViewWrapper)(templateObject_1$a || (templateObject_1$a = __makeTemplateObject(["\n  ", "\n"], ["\n  ", "\n"])), function (props) { return "border: 3px solid ".concat(props.selected ? "purple" : "black", ";"); });
  function picture(embed_data) {
      if (embed_data.images &&
  ...
  function EmbedBlock(props) {
      ...
      return (React.createElement(StyleWrapper$6, { "data-drag-handle": "true", selected: props.selected, className: "graf graf--mixtapeEmbed ".concat(props.selected ? "is-selected is-mediaFocused" : "") },
          React.createElement("span", { contentEditable: false },
              picture(embed_data) ? (React.createElement("a", { target: "_blank", className: "js-mixtapeImage mixtapeImage ".concat(classForImage(embed_data)), href: embed_data.url, style: { backgroundImage: "url('".concat(picture(embed_data), "')") }, rel: "noreferrer" }, " ")) : undefined,
  ...
  function EmbedBlockRenderer(_a) {
      ...
      return (React.createElement("div", { className: "graf graf--mixtapeEmbed" },
          React.createElement("span", { contentEditable: false },
              picture(embed_data) ? (React.createElement("a", { target: "_blank", className: "js-mixtapeImage mixtapeImage ".concat(classForImage(embed_data)), href: embed_data.url, style: { backgroundImage: "url('".concat(picture(embed_data), "')") }, rel: "noreferrer" }, " ")) : undefined,
              React.createElement("a", { className: "markup--anchor markup--mixtapeEmbed-anchor", target: "_blank", href: embed_data.url, rel: "noreferrer" },
                  React.createElement("strong", { className: "markup--strong markup--mixtapeEmbed-strong" }, embed_data.title),
                  React.createElement("em", { className: "markup--em markup--mixtapeEmbed-em" }, embed_data.description)),
              React.createElement("span", null, embed_data.provider_url || embed_data.url))));
  }
  ...
  var StyleWrapper$5 = styled(react.NodeViewWrapper)(templateObject_1$9 || (templateObject_1$9 = __makeTemplateObject([""], [""])));
  function VideoBlock(props) {
      ...
      return (React.createElement(StyleWrapper$5, { as: "figure", "data-drag-handle": "true", className: "graf--figure graf--iframe graf--first ".concat(props.selected ? "is-selected is-mediaFocused" : ""), tabIndex: "0" },
          React.createElement("div", { className: "iframeContainer", dangerouslySetInnerHTML: { __html: renderEmbedHtml() } }),
          React.createElement(react.NodeViewContent, { as: "figcaption", className: "imageCaption" }, props.node.content.size === 0 && (React.createElement("span", { className: "danteDefaultPlaceholder" }, props.extension.options.caption)))));
  }
  ...
  */
  ...
  var StyleWrapper$4 = styled(react.NodeViewWrapper)(templateObject_1$8 || (templateObject_1$8 = __makeTemplateObject(["\n  .editable-content {\n    color: ", ";\n    background: ", ";\n    //border-color: ", ";\n    //border-width: 1px;\n    padding: 10px;\n    border-radius: 5px;\n    box-shadow: 0px 1px 3px 0px #9e9e9e54;\n    ::after {\n      content: attr(data-placeholder);\n      color: #b5b4b4;\n      font-size: 0.6em;\n      width: 100%;\n      border-top: 1px solid #c1c1c1;\n      padding-top: 1px;\n    }\n    button {\n      float: right;\n    }\n  }\n"], ["\n  .editable-content {\n    color: ", ";\n    background: ", ";\n    //border-color: ", ";\n    //border-width: 1px;\n    padding: 10px;\n    border-radius: 5px;\n    box-shadow: 0px 1px 3px 0px #9e9e9e54;\n    ::after {\n      content: attr(data-placeholder);\n      color: #b5b4b4;\n      font-size: 0.6em;\n      width: 100%;\n      border-top: 1px solid #c1c1c1;\n      padding-top: 1px;\n    }\n    button {\n      float: right;\n    }\n  }\n"])), function (props) { return props.theme.dante_text_color; }, function (props) { return props.theme.dante_bg_color; }, function (props) { return props.theme.dante_text_color; });
  function PlaceholderBlock(props) {
      // console.log(props.node.attrs.blockKind);
      return (React.createElement(StyleWrapper$4, { selected: props.selected },
          React.createElement("div", { className: "content" },
              React.createElement(react.NodeViewContent, { className: "editable-content", "data-placeholder": props.node.attrs.blockKind.options.placeholder },
  ...
  var templateObject_1$7, templateObject_2$3, templateObject_3$3, templateObject_4$2, templateObject_5$2, templateObject_6, templateObject_7, templateObject_8, templateObject_9;
  ...
  function VideoRecorderBlock(props) {
    ...
    return /*#__PURE__*/React.createElement(react.NodeViewWrapper, null, /*#__PURE__*/React.createElement(VideoContainer, {
      ref: app,
      ...
      render: function render(_ref) {
        ...
        return /*#__PURE__*/React.createElement("div", null, !isReadOnly() && /*#__PURE__*/React.createElement(StatusBar, {
          ...
          muted: true,
          ref: video
        }), /*#__PURE__*/React.createElement(react.NodeViewContent, {
          as: "figcaption",
  ...
  function VideoRecorderRenderer(_ref3) {
    _ref3.blockKey;
      var data = _ref3.data,
      domain = _ref3.domain;
    var caption = data.caption,
      url = data.url;
    return /*#__PURE__*/React.createElement(VideoContainer, null, /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement(VideoBody, null, /*#__PURE__*/React.createElement(VideoPlayer, {
      autoPlay: true,
      muted: true,
  ...
  var StyleWrapper$3 = styled(react.NodeViewWrapper)(templateObject_1$6 || (templateObject_1$6 = __makeTemplateObject([""], [""])));
  function DividerBlock(props) {
      return (React.createElement(StyleWrapper$3, { "data-drag-handle": "true", selected: props.selected, className: "graf graf--divider is-selected" },
          React.createElement("span", null)));
  }
  ...
  function Code(props) {
      ...
      return (React.createElement(StyleWrapper$2, { "data-drag-handle": "true", selected: props.selected },
          React.createElement("div", { className: "content" },
              ...
              React.createElement(react.NodeViewContent, { as: "pre", className: "hljs" }))));
  }
  ...
  var GiphyBlock$1 = styled.div(templateObject_1$4 || (templateObject_1$4 = __makeTemplateObject(["\n  //position: absolute;\n  //left: 128px;\n  //bottom: 48px;\n  //z-index: 10000;\n  //height: 251px;\n  //background: white;\n  //border: 1px solid #abaaaa;\n  //border-radius: 3px;\n  //width: 223px;\n  //box-shadow: 1px 1px 1px #ece3e3;\n"], ["\n  //position: absolute;\n  //left: 128px;\n  //bottom: 48px;\n  //z-index: 10000;\n  //height: 251px;\n  //background: white;\n  //border: 1px solid #abaaaa;\n  //border-radius: 3px;\n  //width: 223px;\n  //box-shadow: 1px 1px 1px #ece3e3;\n"])));
  var GridListOverflow = styled.div(templateObject_2$2 || (templateObject_2$2 = __makeTemplateObject(["\n  height: 187px;\n  overflow: auto;\n"], ["\n  height: 187px;\n  overflow: auto;\n"])));
  var GridList = styled.div(templateObject_3$2 || (templateObject_3$2 = __makeTemplateObject(["\n  display: flex;\n  display: flex;\n  flex-flow: row wrap;\n  margin-left: 0px;\n  width: 100%;\n  img {\n    flex: auto;\n    height: 250px;\n    min-width: 150px;\n    margin: 0 0px 8px 0;\n  }\n"], ["\n  display: flex;\n  display: flex;\n  flex-flow: row wrap;\n  margin-left: 0px;\n  width: 100%;\n  img {\n    flex: auto;\n    height: 250px;\n    min-width: 150px;\n    margin: 0 0px 8px 0;\n  }\n"])));
  ...
  var App = function (props) {
      var _a = React.useState([]), gifs = _a[0], setGifs = _a[1];
      var _b = React.useState(10), limit = _b[0]; _b[1];
      var _c = React.useState(''), term = _c[0], setTerm = _c[1];
  ...
  var PoweredBy = styled.div(templateObject_1$3 || (templateObject_1$3 = __makeTemplateObject(["\n\n  font-size: 10px;\n  display: flex;\n  justify-content: space-around;\n  justify-items: center;\n  p {\n    margin: 0px;\n  }\n\n"], ["\n\n  font-size: 10px;\n  display: flex;\n  justify-content: space-around;\n  justify-items: center;\n  p {\n    margin: 0px;\n  }\n\n"])));
  ...
  var GiphyBlock = function (props) {
      ...
      return (React.createElement(react.NodeViewWrapper, { className: "dante-giphy-wrapper" },
  ...
  var StartButton = styled.a(templateObject_1$2 || (templateObject_1$2 = __makeTemplateObject(["\n  border-radius: 50%;\n  background-color: #ff5e5e;\n  width: 50px;\n  height: 50px;\n  display: block;\n  margin: 0 auto;\n  cursor: pointer;\n  text-align: center;\n  box-shadow: ", ";\n  svg {\n    margin-top: 12px;\n    fill: white;\n    display: inline;\n    vertical-align: unset !important;\n    &:hover {\n      fill: #222;\n    }\n  }\n"], ["\n  border-radius: 50%;\n  background-color: #ff5e5e;\n  width: 50px;\n  height: 50px;\n  display: block;\n  margin: 0 auto;\n  cursor: pointer;\n  text-align: center;\n  box-shadow: ", ";\n  svg {\n    margin-top: 12px;\n    fill: white;\n    display: inline;\n    vertical-align: unset !important;\n    &:hover {\n      fill: #222;\n    }\n  }\n"])), function (props) {
  ...
  var SpeechRecorderWrapper = styled(react.NodeViewWrapper)(templateObject_4 || (templateObject_4 = __makeTemplateObject(["\n  background: #ccc;\n  padding: 20px;\n  background: #fdffd4;\n  padding: 21px;\n  border: 1px solid #f0f1d9;\n  position: relative;\n"], ["\n  background: #ccc;\n  padding: 20px;\n  background: #fdffd4;\n  padding: 21px;\n  border: 1px solid #f0f1d9;\n  position: relative;\n"])));
  ...
  var SpeechToTextBlock = function (_a) {
      ...
      var _c = React.useState([]), transcript = _c[0], setTranscript = _c[1];
      var _d = React.useState(false), recording = _d[0], setRecording = _d[1];
      var _e = React.useState(null), recognition = _e[0], setRecognition = _e[1];
      React.useEffect(function () {
      ...
      return (React.createElement(SpeechRecorderWrapper, null,
          ...
          React.createElement(react.NodeViewContent, null, transcript.map(function (o) { return o; }))));
  };
  ...
  var StyleWrapper$1 = styled(react.NodeViewWrapper)(templateObject_1$1 || (templateObject_1$1 = __makeTemplateObject([""], [""])));
  function AudioRecorderBlock(props) {
      var _this = this;
      var _a, _b;
      //const { blockProps, block } = props;
      var _c = React.useState(props.node.attrs.stored), stored = _c[0], setStored = _c[1];
      var _d = React.useState(false), recording = _d[0], setRecording = _d[1];
      var _e = React.useState(props.node.attrs.url), audioUrl = _e[0], setAudioUrl = _e[1];
      ...
      return (React.createElement(StyleWrapper$1, { selected: props.selected, as: "figure", "data-drag-handle": "true" },
  ...
  var StyleWrapper = styled(react.NodeViewWrapper)(templateObject_1 || (templateObject_1 = __makeTemplateObject([""], [""])));
  function FileBlock(props) {
      ...
      function replaceFile() {
          // exit only when not blob and not forceUload
          if (!props.node.attrs.url.includes('blob:') &&
      ...
      return (React.createElement(StyleWrapper, { selected: props.selected, as: "figure", "data-drag-handle": "true" },
          React.createElement("a", { href: imageUrl, target: "blank", className: "flex items-center border rounded text-sm text-gray-100 bg-gray-500 border-gray-600 p-2 py-2" },
  ...
  var FileBlockConfig = function (options) {
      ...
      var config = {
          ...
          dataSerializer: function (data) {
              return _assign(_assign({}, data), { src: data.url, aspect_ratio: JSON.stringify(data.aspect_ratio), file: null });
          },
          options: {
              upload_handler: function (file, ctx) {
                  console.log("UPLOADED FILE", file);
  ...
  function FileBlockRenderer(_a) {
      ...
      var url = data.url, caption = data.caption;
      return (React.createElement("figure", { key: blockKey, className: "graf graf--figure" },
          React.createElement("a", { href: url, target: "blank", className: "flex items-center border rounded text-sm text-gray-100 bg-gray-500 border-gray-600 p-2 py-2" },
              React.createElement(file, null),
  ...
  var DanteEditor = function (_a) {
      var bodyPlaceholder = _a.bodyPlaceholder, widgets = _a.widgets, extensions = _a.extensions; _a.fixed; var content = _a.content, onUpdate = _a.onUpdate, readOnly = _a.readOnly, autofocus = _a.autofocus, tooltips = _a.tooltips, editorProps = _a.editorProps;
      ...
      return (React.createElement(React.Fragment, null,
          ...
          React.createElement(react.EditorContent, { editor: editor }),
          defaultTooltips()
              .filter(function (o) { return o.placement !== "up"; })
              .map(function (o, i) {
              return renderTooltip(o, i);
  ...
  function Editor(props) {
      ...
      return (React.createElement(react$1.ThemeProvider, { theme: props.theme || theme },
  ...
  function Renderer(_a) {
      ...
      var convertNodeToElement = function (node) {
          switch (node.type) {
              ...
              case 'text':
                  ...
                  return textElement;
              case 'table':
                  return (React.createElement("table", { className: "table-auto graf graf--table", key: node.id },
                      React.createElement("tbody", null, traverseNodes(node.content))));
              case 'tableRow':
                  return React.createElement("tr", { className: "graf graf--tr", key: node.id }, traverseNodes(node.content));
              case 'tableHeader':
                  return (React.createElement("th", { className: "graf graf--th", key: node.id, colSpan: node.attrs.colspan, rowSpan: node.attrs.rowspan }, traverseNodes(node.content)));
              case 'tableCell':
                  return (React.createElement("td", { className: "graf graf--td", key: node.id, colSpan: node.attrs.colspan, rowSpan: node.attrs.rowspan }, traverseNodes(node.content)));
      ...
      return (React.createElement(react$1.ThemeProvider, { theme: theme$1 || theme },
          React.createElement(EditorContainer, null,
  ...
  exports.AddButtonConfig = AddButtonConfig;
  exports.AudioRecorderBlock = AudioRecorderBlock;
  exports.AudioRecorderBlockConfig = AudioRecorderBlockConfig;
  exports.CodeBlock = Code;
  exports.CodeBlockConfig = CodeBlockConfig;
  exports.Dante = DanteEditor;
  ...
  exports.FileBlockConfig = FileBlockConfig;
  ...
  exports.MenuBarConfig = MenuBarConfig;
